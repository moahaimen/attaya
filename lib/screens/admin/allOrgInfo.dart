...
//                                          height: 250,
                                          child: Card(
                                              ...
                                              margin: EdgeInsets.symmetric(vertical: 7,horizontal:
                                              30),
                                          ...
                                          children: <Widget>[
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                children: <Widget>[
                                                  Text('قراءة المزيد', textAlign: TextAlign.right,
                                                    textDirection: TextDirection.rtl,style: SmallCarText,),
                                                ],
                                              ),
                                            ),
                                            Expanded(
                                            ...
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                children: <Widget>[
                                                  Text('ارسال رسالة على الهاتف', textAlign: TextAlign.right,
                                                    textDirection: TextDirection.rtl,style: SmallCarText,),
                                                ],
                                              ),
                                            ),

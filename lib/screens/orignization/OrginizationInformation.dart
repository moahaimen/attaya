                                        ...
                                        Container(
                                          width: 350,
                                            ...
                                            child: Card(
                                                ...
                                                margin: EdgeInsets.symmetric(vertical: 55,horizontal:
                                                30),
...
//                                  mainAxisAlignment: MainAxisAlignment.end,
                          ...
                          Container(
                            ...
                            children: <Widget>[
                              SizedBox(height: 50,
                              width: 280,
                              child: ButtonBlueOldShape('ارسال رسالة للمنظمة',context,
                                  txt()
                              ),
                              ),
                          ...
                          SizedBox(height: 10,),
                              ...
                              Padding(
                                padding: EdgeInsets.only(left:10,right: 10.0,
                                    top: 28,bottom: 5),
                                child: Text("منظمة خيرية تعمل من اجل العراق والشعب العراقي تاسست سنة 2003 تقوم بتوزيع المعونات الشهرية  للعوائل",

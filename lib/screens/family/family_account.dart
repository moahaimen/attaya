...
class FamilyAccount extends StatelessWidget {
  ...
  const FamilyAccount({Key key, this.hasLoginIcon = false}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    final familyData = Provider.of<Family>(context);

    return Scaffold(
      appBar: apBar('حساب العائلة', context,
          isNotsubScreen: true, hasLoginIcon: hasLoginIcon),
      body: familyData == null
          ? const Loading()
          : ListView(
              children: <Widget>[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                        color: const Color.fromRGBO(35, 68, 199, 0.86),
                        width: 3),
